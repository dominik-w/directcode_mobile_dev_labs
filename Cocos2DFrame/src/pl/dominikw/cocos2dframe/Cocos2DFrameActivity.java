/*
 * Cocos2D project template.
 */

package pl.dominikw.cocos2dframe;
...
public class Cocos2DFrameActivity extends Activity {
	...
	static class TemplateLayer extends CCLayer {
		...
		protected TemplateLayer() {
			...
			lbl = CCLabel.makeLabel("Hello games!", "DroidSans", 18);
